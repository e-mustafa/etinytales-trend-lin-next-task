		...
		<header className='flex flex-wrap lg:justify-start lg:flex-nowrap z-50 w-full py-5 bg-white shadow-[0px_0px_52px_-24px_#00000040]'>
			<nav className='relative max-w-7xl w-full flex gap-[42px] justify-between lg:justify-start basis-full items-center px-4 md:px-6 lg:px-10 mx-auto'>
				<div className=' flex items-center'>
					{/* <!-- Logo --> */}
					<a
						className='flex-none h-[35px] md:h-[51px] w-[45px] md:w-[66px] rounded-xl text-xl flex items-center gap-1 font-semibold focus:outline-hidden focus:opacity-80'
						href='/'
						aria-label='Preline'
					>
				...
				<div className='lg:hidden'>
					<button type='button' className='size-6' aria-label='Toggle navigation'>
						<svg width='24' height='25' viewBox='0 0 24 25' fill='none' xmlns='http://www.w3.org/2000/svg'>
							<path
								d='M20 18C20.3852 18.0002 20.7556 18.1486 21.0344 18.4144C21.3132 18.6802 21.479 19.0431 21.4975 19.4279C21.516 19.8127 21.3858 20.1898 21.1338 20.4812C20.8818 20.7726 20.5274 20.9558 20.144 20.993L20 21H4C3.61478 20.9998 3.24441 20.8514 2.96561 20.5856C2.68682 20.3198 2.52099 19.9569 2.50248 19.5721C2.48396 19.1873 2.61419 18.8102 2.86618 18.5188C3.11816 18.2274 3.47258 18.0442 3.856 18.007L4 18H20ZM20 11C20.3978 11 20.7794 11.158 21.0607 11.4393C21.342 11.7206 21.5 12.1022 21.5 12.5C21.5 12.8978 21.342 13.2794 21.0607 13.5607C20.7794 13.842 20.3978 14 20 14H4C3.60218 14 3.22064 13.842 2.93934 13.5607C2.65804 13.2794 2.5 12.8978 2.5 12.5C2.5 12.1022 2.65804 11.7206 2.93934 11.4393C3.22064 11.158 3.60218 11 4 11H20ZM20 4C20.3978 4 20.7794 4.15804 21.0607 4.43934C21.342 4.72064 21.5 5.10218 21.5 5.5C21.5 5.89782 21.342 6.27936 21.0607 6.56066C20.7794 6.84196 20.3978 7 20 7H4C3.60218 7 3.22064 6.84196 2.93934 6.56066C2.65804 6.27936 2.5 5.89782 2.5 5.5C2.5 5.10218 2.65804 4.72064 2.93934 4.43934C3.22064 4.15804 3.60218 4 4 4H20Z'
								fill='#020202'
							/>
						</svg>
					</button>
