...
export async function registerAction(prevState, formData) {
	try {
		...
		console.log('user data --', token, id, name, email, image, mobile, mobile_country_code, count_items_cart);
		...
		!isPROD && console.error('Register error:', err);
		return err;
	}
}
